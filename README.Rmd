...
All scripts were written in such a way that folding the code will make navigation easier. R code can be (un-)folded by navigating to Edit->Folding->Collapse All 
or, depending on the system you are using, with the shortcuts: alt+cmd+o or Ctrl+Alt+o
...
## Help                       
If you need help with using this script, please don't hesitate to contact me (using Github or finding my current email-address online searching for Sophia Braumann ;)
